...
> Policy × Tech · Climber · Outdoorsman 

D.C.-based policy staffer who writes code on the side. I work at the intersection of national security, law, and technology — and spend my weekends as far from a screen as possible.

---

## What I'm up to

- 🏛️ Working in Washington, D.C.
- 🛠️ Managing staff and internal tooling for a 100k+ member Marvel community on Discord
- 🧗 Climbing (V7) · Backpacking · Camping · Boondocking
- 🚣 Rowing whenever I can convince myself to wake up early enough
...
`🛡️ National security` &nbsp; `⚖️ Judiciary` &nbsp; `🌐 Immigration`

---

## Code tools & languages
...
![R](https://img.shields.io/badge/R-198CE7?style=flat&logo=r&logoColor=white)

**Intermediate**

![Java](https://img.shields.io/badge/Java-B07219?style=flat&logo=openjdk&logoColor=white)
![C#](https://img.shields.io/badge/C%23-178600?style=flat&logo=dotnet&logoColor=white)
